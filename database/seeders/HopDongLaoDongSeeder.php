    ...
    public function run(): void
    {
        DB::table('hop_dong_lao_dong')->insert([
            ...
            [
                ...
                'trang_thai_ky' => 'da_ky',
                'nguoi_ky_id' => 2,
                'thoi_gian_ky' => '2025-02-01 14:30:00',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'hinh_thuc_lam_viec' => 'Toàn thời gian',
                'dia_diem_lam_viec' => 'Hà Nội',
                'ghi_chu' => 'Hợp đồng xác định thời hạn.',
                'duong_dan_file' => '/storage/hop-dong/HD003-2024.pdf',
                'dieu_khoan' => 'Hợp đồng xác định thời hạn.',
            ...
            [
                ...
                'dieu_khoan' => 'Hợp đồng 2 năm, làm việc theo dự án.',
                'trang_thai_hop_dong' => 'hieu_luc',
                'trang_thai_ky' => 'da_ky',
                'nguoi_ky_id' => 2,
            ...
            [
                ...
                'hinh_thuc_lam_viec' => 'Toàn thời gian',
                'dia_diem_lam_viec' => 'Hà Nội',
                'ghi_chu' => 'Hợp đồng mới tạo, chờ phê duyệt.',
                'duong_dan_file' => null,
                'dieu_khoan' => 'Thực hiện đúng quy định của công ty, bảo mật thông tin.',
                'trang_thai_hop_dong' => 'hieu_luc',
                'trang_thai_ky' => 'da_ky',
                'nguoi_ky_id' => 2,
                'thoi_gian_ky' => '2024-12-01 09:45:00',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'nguoi_dung_id' => 7,
                'chuc_vu_id' => 7,
                'so_hop_dong' => 'HD007-2024',
                'loai_hop_dong' => 'xac_dinh_thoi_han',
                'ngay_bat_dau' => '2025-08-15',
                'ngay_ket_thuc' => '2026-02-14',
                ...
                'duong_dan_file' => null,
                'dieu_khoan' => 'Hưởng đầy đủ chế độ đãi ngộ',
                'trang_thai_hop_dong' => 'hieu_luc',
                'trang_thai_ky' => 'da_ky',
                'nguoi_ky_id' => 2,
                'thoi_gian_ky' => '2025-08-15 09:00:00',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
