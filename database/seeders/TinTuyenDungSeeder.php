    ...
    public function run(): void
    {
         DB::table('tin_tuyen_dung')->insert([
            [
                ...
                'yeu_cau' => 'Có kinh nghiệm PHP, Laravel, MySQL',
                'phuc_loi' => 'Lương tháng 13, bảo hiểm đầy đủ',
            ...
            [
                ...
                'yeu_cau' => 'Có hiểu biết về marketing digital',
                'phuc_loi' => 'Chế độ đãi ngộ tốt, môi trường trẻ',
                'ky_nang_yeu_cau' => json_encode(['Marketing Digital', 'Social Media', 'Photoshop']),
            ...
            [
                ...
                'yeu_cau' => 'Có bằng kế toán, kinh nghiệm 2 năm',
                'phuc_loi' => 'Lương thưởng hấp dẫn',
                'ky_nang_yeu_cau' => json_encode(['Excel', 'Phần mềm kế toán', 'Báo cáo tài chính']),
                'trinh_do_hoc_van' => 'Đại học',
