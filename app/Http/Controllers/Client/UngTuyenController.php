...
class UngTuyenController extends Controller
{
    ...
    public function guiemailAll(Request $request)
    {
        ...
        foreach ($ungviens as $ungvien) {
          Http::withOptions(['verify' => false])->post('https://binhboo.app.n8n.cloud/webhook-test/send-email', [
    ...
    public function guiEmailDiLam(Request $request)
    {
        ...
        foreach ($ungviens as $ungvien) {
            ...
            try {
                Http::withOptions(['verify' => false])->timeout(5)->post('https://binhboo.app.n8n.cloud/webhook-test/email-di-lam', [
