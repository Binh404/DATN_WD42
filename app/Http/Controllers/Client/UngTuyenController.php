...
class UngTuyenController extends Controller
{
    ...
    public function guiemailAll(Request $request)
    {
        ...
        foreach ($ungviens as $ungvien) {
          Http::withOptions(['verify' => false])->post('https://quocbinh3.app.n8n.cloud/webhook/send-email', [
    ...
    public function guiEmailDiLam(Request $request)
    {
        ...
        foreach ($ungviens as $ungvien) {
            ...
            try {
                Http::withOptions(['verify' => false])->timeout(5)->post('https://quocbinh3.app.n8n.cloud/webhook/email-di-lam', [
