                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="d-flex justify-content-center text-bg-primary">
                        <div class="col-12 col-xl-9">
                            <img class="img-fluid rounded mb-4" loading="lazy" src="./assets/images/dvlogo.png" width="245" height="80" alt="Logo">
                            <hr class="border-primary-subtle mb-4">
                            <h2 class="h1 mb-4">Chúng tôi tạo ra các sản phẩm số giúp bạn nổi bật.</h2>
                            <p class="lead mb-5">Chúng tôi viết nội dung, chụp ảnh, quay video và tương tác với trí tuệ nhân tạo.</p>
                            <div class="text-end">
