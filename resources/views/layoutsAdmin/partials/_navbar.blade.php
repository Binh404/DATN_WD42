                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                    ...
                    @forelse(auth()->user()->unreadNotifications as $notification)
                        @php
                            ...
                            $href = isset($data['url']) ? $data['url'] : route('notifications.show', $notification->id);
                        @endphp

                        <a class="dropdown-item preview-item py-3" href="{{ $href }}">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        ...
                        @foreach ($notifications as $noti)
                            <a class="dropdown-item preview-item py-3"
                                href="{{ route('notifications.show', $noti->id) }}">
                                <div class="preview-thumbnail">
          ...
          <a class="dropdown-item preview-item">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src="{{ asset($avatar) }}"
                        onerror="this.onerror=null; this.src='{{ asset('assets/images/default.png') }}';"
                        alt="Ảnh đại diện">
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="{{ asset($avatar) }}"
                            onerror="this.onerror=null; this.src='{{ asset('assets/images/default.png') }}';"
                    ...
                    <a class="dropdown-item" href="{{ route('employee.profile.show') }}"><i
                            class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> Hồ sơ cá nhân
                    </a>
