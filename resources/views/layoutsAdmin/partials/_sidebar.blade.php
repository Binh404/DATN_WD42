<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-hoso" aria-expanded="false" aria-controls="ui-hoso">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="charts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('phieuluong.index') }}">Phiếu Lương</a>
                    </li>
                </ul>
            </div>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link  " href="{{ route('admin.chamcong.tangCa.index') }}">Danh
                            sách tăng ca</a></li>
                    <li class="nav-item"> <a class="nav-link  " href="{{ route('admin.locations.index') }}">Quản lý vị
                            trí</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#captrenthongbao" aria-expanded="false"
                aria-controls="tables">
                <i class="menu-icon mdi mdi-clock-outline"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('hr.loainghiphep.index') }}" aria-expanded="false"
                aria-controls="tables">
                <i class="menu-icon mdi mdi-clock-outline"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#icons" aria-expanded="false"
                ...
                <a class="nav-link" data-bs-toggle="collapse" href="#hd" aria-expanded="false"
                    aria-controls="hd">
                ...
                <div class="collapse" id="hd">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('hopdong.index') }}">Danh sách</a>
                        </li>
                    </ul>
                </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="ttd">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('hr.tintuyendung.index') }}">Tin đã
                            đăng</a></li>
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#cttb" aria-expanded="false"
                aria-controls="cttb">
                <i class="menu-icon mdi mdi-layers-outline"></i>
            ...
            <div class="collapse" id="cttb">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('hr.captrenthongbao.tuyendung.index') }}">Tuyển dụng</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="dd">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.duyetdon.tuyendung.index') }}">Tuyển dụng</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('department.donxinnghi.danhsach') }}">Xin nghỉ phép</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
