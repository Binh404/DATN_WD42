...
<!-- Bootstrap CSS -->
  ...
  $(document).ready(function() {
    // Khi click vào item của sidebar, toggle (mở/đóng) lớp 'menu-open'
    $(".nav-item > a").click(function(e) {
      var $parent = $(this).parent(); // Lấy phần tử cha (li)
      var $submenu = $parent.children("ul"); // Tìm submenu của item đó

    //   // Kiểm tra nếu submenu đang mở
    //   if ($submenu.is(":visible")) {
    //     $submenu.slideUp(); // Đóng submenu nếu nó đang mở
    //     $parent.removeClass("menu-open"); // Loại bỏ class menu-open
    //   } else {
    ...
    //     // Mở submenu hiện tại
    //     $submenu.slideDown();
    //     $parent.addClass("menu-open"); // Thêm class menu-open vào mục hiện tại
    //   }
