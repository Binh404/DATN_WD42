            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    @if ($hopdong)
                                ...
                                <td>
                                    @if ($hopdong->duong_dan_file)
                                        <a href="{{ asset('storage/' . $hopdong->duong_dan_file) }}" target="_blank"
                                            class="btn btn-sm btn-primary">Xem file hợp đồng</a>
                                    @else
                        ...
                        @if ($hopdong->trang_thai_ky == 'cho_ky')
                            <form action="{{ route('hopdong.xacnhanky', $hopdong->id) }}" method="POST"
                            ...
                            <button class="btn btn-danger"
                                onclick="document.getElementById('tuChoiForm').style.display='block'">Từ chối ký</button>
                            <form id="tuChoiForm" action="{{ route('hopdong.tuchoiky', $hopdong->id) }}" method="POST"
