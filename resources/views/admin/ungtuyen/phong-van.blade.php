    ...
    <div class="container mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="fw-bold mb-1">Quản lý danh sách ứng viên phỏng vấn</h2>
                    <p class="mb-0 opacity-75">Thông tin chi tiết bản ghi ứng viên phỏng vấn</p>
                </div>
        ...
        <form action="/ungvien/guiemailall" method="POST" style="margin-bottom: 15px;" onsubmit="return confirm('Bạn có muốn gửi email không!')" class="mt-4">
            @csrf
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('ungvien.phong-van') }}">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <!-- Tên ứng viên -->
    ...
    <!--
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="/ungvien/{{ $uv->id }}/show/?from=phong-van" class="btn btn-sm btn-info text-white">
