    ...
    <div class="container-fluid px-4">
        ...
        <div class="row align-items-center mb-4">
            ...
            <div class="col-md-3 text-end">
                <a href="{{ route('hr.loainghiphep.create') }}" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus me-2"></i>Tạo loại nghỉ phép
                </a>
            </div>
                ...
                <div class="table-responsive">
                            ...
                            @foreach ($loaiNghiPheps as $index => $item)
                                <tr class="border-bottom">
                                    ...
                                    <td class="px-4 py-3 align-middle">
                                        @if ($item->co_luong == 1)
                                            <span
                                                class="badge text-success px-3 py-2">
                                    ...
                                    <td class="px-4 py-3 align-middle">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="{{ route('hr.loainghiphep.show', $item->id) }}"
                                                class="btn btn-outline-success btn-sm rounded-pill" data-bs-toggle="tooltip"
                                                title="Chi tiết">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted mb-3">Không tìm thấy loại nghỉ phép nào</h5>
                            @if (request('search'))
                            ...
                            @else
                                <p class="text-muted mb-4">Chưa có loại nghỉ phép nào được tạo.</p>
                            @endif
                            <a href="/yeu$item/create" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>Thêm loại nghỉ phép đầu tiên
                            </a>
                        </div>
                    @endif
                </div>
