                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value highlight">
                                @if ($tuyenDung->trang_thai === 'dang_tuyen')
                                    <div class="text-success">Đang tuyển</div>
                                @elseif($tuyenDung->trang_thai === 'nhap')
                                    <div class="text-black">Nhap</div>
                                @elseif($tuyenDung->trang_thai === 'tam_dung')
                                    <div class="text-danger">Tạm dừng</div>
                                @elseif($tuyenDung->trang_thai === 'ket_thuc')
                                    <div class="text-warning">Kết thúc</div>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="description-section">
                            ...
                            <div class="description-content">
                                {{ is_array($tuyenDung->yeu_cau) ? implode(', ', $tuyenDung->yeu_cau) : $tuyenDung->yeu_cau }}
                            </div>
                        </div>
                    </div>
