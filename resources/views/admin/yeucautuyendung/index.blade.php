                                ...
                                @foreach ($yeuCauTuyenDungs as $index => $yeuCauTuyenDung)
                                    <tr class="border-bottom">
                                        <td class="px-4 py-3 align-middle">
                                            <code
                                                class="bg-light text-dark px-2 py-1 rounded">{{ $yeuCauTuyenDung->ma }}</code>
                                        </td>
                                        <td class="px-4 py-3 align-middle">
                                        ...
                                        <td class="px-4 py-3 align-middle">
                                            <div class="d-flex gap-2 justify-content-center">
                                                <a href="{{ route('department.yeucautuyendung.edit', ['id' => $yeuCauTuyenDung->id]) }}"
                                                    class="btn btn-outline-warning btn-sm rounded-pill"
                                                    data-bs-toggle="tooltip" title="Chỉnh sửa">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <a href="{{ route('department.yeucautuyendung.show', ['id' => $yeuCauTuyenDung->id]) }}"
                                                ...
                                                <form
                                                    action="{{ route('department.yeucautuyendung.cancel', $yeuCauTuyenDung->id) }}"
