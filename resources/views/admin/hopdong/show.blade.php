                            ...
                            <div class="mb-4">
                                ...
                                <table class="table table-bordered mx-auto" style="width: 95%;">
                                    <tr>
                                        ...
                                        <td>{{ $hopDong->hoSoNguoiDung ? $hopDong->hoSoNguoiDung->ma_nhan_vien : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Họ và tên</th>
                                        <td>{{ $hopDong->hoSoNguoiDung ? $hopDong->hoSoNguoiDung->ho . ' ' . $hopDong->hoSoNguoiDung->ten : 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Chức vụ</th>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-2">
                                        @php
                                            ...
                                            $attachmentFileExt = strtolower(
                                                pathinfo($hopDong->file_dinh_kem, PATHINFO_EXTENSION),
                                            );
                                        @endphp
                                        <div class="mb-2">
                                            <a href="{{ asset('storage/' . $hopDong->file_dinh_kem) }}" target="_blank"
                                                class="btn btn-secondary btn-sm me-2" title="Xem file">
        ...
        <div class="col-12">
            ...
            <div class="btn-group" style="display: flex; align-items: stretch; gap: 5px;">
                ...
                @if ($hopDong->trang_thai_hop_dong === 'tao_moi')
                    ...
                    @endphp
                    @if ($canApprove)
                        <form action="{{ route('hopdong.phe-duyet', $hopDong->id) }}" method="POST"
                            style="display: inline;">
                            @csrf
                            <button type="submit" class="btn btn-success"
                                onclick="return confirm('Bạn có chắc chắn muốn gửi hợp đồng này cho nhân viên?')">
