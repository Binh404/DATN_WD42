                    ...
                    <div class="card stat-card h-120">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img src="{{ $avatar }}" alt="Avatar"
                                class="rounded-circle border border-3 border-primary mb-3" width="100" height="100"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="trang_thai" id="trang_thai" class="form-select" required>
                                            <option value="1" {{ $taikhoan->trang_thai == 1 ? 'selected' : '' }}>Hoạt
                                                động</option>
                                            <option value="0" {{ $taikhoan->trang_thai == 0 ? 'selected' : '' }}>Ngưng
                                                hoạt động
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="phong_ban_id" id="phong_ban_id" class="form-select" required>
                                            ...
                                            @foreach ($ds_phongban as $phongban)
                                                <option value="{{ $phongban->id }}"
                                                    {{ $taikhoan->phong_ban_id == $phongban->id ? 'selected' : '' }}>
                                        ...
                                        <select name="chuc_vu_id" id="chuc_vu_id" class="form-select" required>
                                            ...
                                            @foreach ($ds_chucvu as $chucvu)
                                                <option value="{{ $chucvu->id }}"
                                                    {{ $taikhoan->chuc_vu_id == $chucvu->id ? 'selected' : '' }}>
                                                    {{ $chucvu->ten }}
                                                </option>
                                            @endforeach
                                        </select>
