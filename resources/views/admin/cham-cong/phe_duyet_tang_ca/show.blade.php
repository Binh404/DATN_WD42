            ...
            <div class="col-12">
                ...
                <div class="info-card p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-1">Chi tiết đơn tăng ca</h2>
                            <p class="mb-0 opacity-75">Thông tin chi tiết đơn tăng ca</p>
                    ...
                    <div class="col-lg-5 mb-4">
                        <div class="card h-100 shadow-sm border-0 rounded-3">
                            ...
                            <div class="card-body text-center p-4 ">
                                @php
                                    $avatar = $dangKyTangCa->nguoiDung->hoSo->anh_dai_dien
                                        ? asset($dangKyTangCa->nguoiDung->hoSo->anh_dai_dien)
                                ...
                                <h4 class="fw-bold text-primary mb-3">
                                    {{ $dangKyTangCa->nguoiDung->hoSo->ho ?? 'N/A' }} {{ $dangKyTangCa->nguoiDung->hoSo->ten ?? 'N/A' }}
                                </h4>
                                ...
                                <div class="text-start">
                                    <div
                                        ...
                                        <strong class="text-dark"><i class="mdi mdi-badge-account me-2 text-primary"></i>Mã nhân
                                            viên:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $dangKyTangCa->nguoiDung->hoSo->ma_nhan_vien ?? 'N/A' }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-email me-2 text-primary"></i>Email:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $dangKyTangCa->nguoiDung->email }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-office-building me-2 text-primary"></i>Phòng
                                            ban:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $dangKyTangCa->nguoiDung->phongBan->ten_phong_ban ?? 'N/A' }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-phone me-2 text-primary"></i>Số điện thoại:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $dangKyTangCa->nguoiDung->hoSo->so_dien_thoai ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 mb-4">
                        <div class="card h-100 shadow-sm border-0 rounded-3">
                            <div class="card-header bg-success text-white py-3 px-4">
                                <h5 class="mb-0 d-flex align-items-center">
                                    <i class="mdi mdi-clock me-2"></i>Thông tin chấm công
                                </h5>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                <h6 class="mb-1 fw-medium text-dark">Ngày chấm công</h6>
                                                <span
                                                    class="text-muted">{{ \Carbon\Carbon::parse($dangKyTangCa->ngay_tang_ca)->format('d/m/Y') }}</span>
                                                <br>
                                                <small
                                                    class="text-primary fw-medium">{{ \Carbon\Carbon::parse($dangKyTangCa->ngay_tang_ca)->locale('vi')->dayName }}</small>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <span class="badge bg-success rounded-pill px-2 py-1">
                                                    {{ $dangKyTangCa->gio_bat_dau->format('H:i') }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <span class="badge bg-danger rounded-pill px-2 py-1">
                                                    {{ $dangKyTangCa->gio_ket_thuc->format('H:i') }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <h4 class="text-primary mb-0">{{ number_format($dangKyTangCa->so_gio_tang_ca, 1) }} giờ
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                @php
                                                    $statusColors = [
                                                        'ngay_thuong' => 'bg-success',
                                                        'ngay_nghi' => 'bg-secondary',
                                                        'le_tet' => 'bg-warning',
                                                    ];
                                                @endphp
                                                <span
                                                    class="badge {{ $statusColors[$dangKyTangCa->loai_tang_ca] ?? 'bg-secondary' }} rounded-pill px-2 py-1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                @endphp
                                                <span
                                                    class="badge {{ $statusColors[$dangKyTangCa->trang_thai] ?? 'bg-secondary' }} rounded-pill px-2 py-1">
                                            ...
                                            <div class="card border-0 bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-muted mb-1 mt-2">
                                                        Cập nhật bởi: {{ $dangKyTangCa->nguoiPheDuyet->hoSo->ho ?? 'Hệ thống' }}
                                                        {{ $dangKyTangCa->nguoiPheDuyet->hoSo->ten ?? '' }}
                                                    </p>
                                                    <small class="text-muted">
                                                        {{ $dangKyTangCa->thoi_gian_phe_duyet ? \Carbon\Carbon::parse($dangKyTangCa->thoi_gian_phe_duyet)->format('d/m/Y H:i') : 'Chưa xử lý' }}
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card stat-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span
                                        class="float-end">{{ \Carbon\Carbon::parse($dangKyTangCa->created_at)->format('d/m/Y H:i') }}</span>
                                </div>

                                <div class="detail-row">
                                    <strong><i class="mdi mdi-clock-edit me-2 text-warning"></i>Cập nhật cuối:</strong>
                                    <span
                                        class="float-end">{{ \Carbon\Carbon::parse($dangKyTangCa->updated_at)->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card stat-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-center gap-3">
                                    <a href="{{ route('admin.chamcong.xemPheDuyetTangCa') }}" class="btn btn-secondary">
                                        <i class="mdi mdi-arrow-left me-1"></i> Quay lại danh sách
                                    </a>

                                    @if($dangKyTangCa->trang_thai == 'cho_duyet' || !$dangKyTangCa->trang_thai || $dangKyTangCa->trang_thai == 'huy')
                                        <button class="btn btn-success" onclick="pheDuyet({{ $dangKyTangCa->id }}, 'da_duyet')">
                                            <i class="mdi mdi-check me-1"></i> Phê duyệt
                                        </button>
                                        <button class="btn btn-danger" onclick="pheDuyet({{ $dangKyTangCa->id }}, 'tu_choi')">
                                            <i class="mdi mdi-close me-1"></i> Từ chối
                                        </button>
                                    @endif
                                    @if(!($dangKyTangCa->trang_thai == 'huy') || !$dangKyTangCa->trang_thai)

                                    <button class="btn btn-dark" onclick="pheDuyet({{ $dangKyTangCa->id }}, 'huy')">
                                        <i class="mdi mdi-delete me-1"></i>Hủy
                                    </button>
                                    @endif
                    ...
                    <form id="pheDuyetForm" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="ghiChuPheDuyet" name="ly_do_tu_choi" rows="3"></textarea>
                            </div>
                        </div>
