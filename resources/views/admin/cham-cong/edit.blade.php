        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mb-0"><i class="fas fa-edit"></i> Chỉnh Sửa Chấm Công</h1>
                        <p class="mb-0">Cập nhật thông tin chấm công nhân viên</p>
                    </div>
                    <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $chamCong->nguoiDung->hoSo->ho ?? '' }} {{ $chamCong->nguoiDung->hoSo->ten ?? '' }}"
                                        readonly>

                                    <!-- input hidden giữ giá trị id để gửi lên server -->
                                    <input type="hidden" name="nguoi_dung_id" value="{{ $chamCong->nguoi_dung_id }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('ngay_cham_cong') is-invalid @enderror"
                                           ...
                                           value="{{ old('ngay_cham_cong', $chamCong->ngay_cham_cong->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" class="form-control @error('gio_vao') is-invalid @enderror"
                                           ...
                                           value="{{ old('gio_vao', $chamCong->gio_vao->format('H:i')) }}">
                                    @error('gio_vao')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Giờ vào làm tiêu chuẩn: 08:30</small>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" class="form-control @error('gio_ra') is-invalid @enderror"
                                           ...
                                           value="{{ old('gio_ra', $chamCong->gio_ra ? $chamCong->gio_ra->format('H:i') : '') }}">
                                    @error('gio_ra')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Giờ tan làm tiêu chuẩn: 17:30</small>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('trang_thai') is-invalid @enderror"
                                        ...
                                        @foreach($trangThaiList as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ old('trang_thai', $chamCong->trang_thai) == $key ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('trang_thai_duyet') is-invalid @enderror"
                                            id="trang_thai_duyet" name="trang_thai_duyet">
                                ...
                                <!-- Ghi chú phê duyệt -->
                                <div class="col-12 mb-3">
                                    <label for="ghi_chu_duyet" class="form-label">Ghi chú phê duyệt</label>
                                    <textarea class="form-control @error('ghi_chu_duyet') is-invalid @enderror"
                                              id="ghi_chu_duyet" name="ghi_chu_duyet" rows="2"
                                              placeholder="Ghi chú khi phê duyệt (tùy chọn)">{{ old('ghi_chu_duyet', $chamCong->ghi_chu_duyet) }}</textarea>
                                    @error('ghi_chu_duyet')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 p-3 bg-light rounded">
                                ...
                                <div><strong>Tên:</strong> {{ $chamCong->nguoiDung->hoSo->ho ?? 'N/A' }} {{ $chamCong->nguoiDung->hoSo->ten ?? 'N/A' }}</div>
                                <div><strong>Email:</strong> {{ $chamCong->nguoiDung->email }}</div>
                                <div><strong>Phòng ban:</strong> {{ $chamCong->nguoiDung->phongBan->ten_phong_ban ?? 'N/A' }}</div>
                            </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 small">
                                    <li>Giờ vào làm tiêu chuẩn: 08:30</li>
                                    <li>Giờ tan làm tiêu chuẩn: 17:30</li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('admin.chamcong.index') }}" class="btn btn-outline-secondary">
