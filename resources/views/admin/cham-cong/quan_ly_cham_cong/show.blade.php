            ...
            <div class="col-12">
                ...
                <div class="info-card p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-1">Chi tiết chấm công</h2>
                                ...
                                <div class="text-start">
                                    <div
                                        ...
                                        <strong class="text-dark"><i class="mdi mdi-badge-account me-2 text-primary"></i>Mã nhân
                                            viên:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $chamCong->nguoiDung->hoSo->ma_nhan_vien ?? 'N/A' }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-email me-2 text-primary"></i>Email:</strong>
                                        <span class="badge bg-primary rounded-pill px-2 py-1">{{ $chamCong->nguoiDung->email }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-office-building me-2 text-primary"></i>Phòng
                                            ban:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $chamCong->nguoiDung->phongBan->ten_phong_ban ?? 'N/A' }}</span>
                                    </div>
                                    <div
                                        class="detail-row d-flex justify-content-between align-items-center p-2 rounded hover-bg-light transition">
                                        <strong class="text-dark"><i class="mdi mdi-phone me-2 text-primary"></i>Số điện thoại:</strong>
                                        <span
                                            class="badge bg-primary rounded-pill px-2 py-1">{{ $chamCong->nguoiDung->hoSo->so_dien_thoai ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card h-100 shadow-sm border-0 rounded-3">
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="text-muted">{{ \Carbon\Carbon::parse($chamCong->ngay_cham_cong)->format('d/m/Y') }}</span>
                                                <br>
                                                <small
                                                    class="text-info fw-medium">{{ \Carbon\Carbon::parse($chamCong->ngay_cham_cong)->locale('vi')->dayName }}</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            <div class="icon-circle bg-{{ $chamCong->kiemTraDiMuon() ? 'warning' : 'success' }} text-white d-flex align-items-center justify-content-center rounded-circle me-3"
                                                style="width: 40px; height: 40px;">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="badge bg-{{ $chamCong->kiemTraDiMuon() ? 'warning' : 'success' }} rounded-pill px-2 py-1">
                                                    {{ $chamCong->gio_vao_format }}
                                                </span>
                                                @if($chamCong->phut_di_muon > 0)
                                                    <br><small class="text-warning fw-medium">Đi muộn: {{ $chamCong->phut_di_muon }}
                                                        phút</small>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            <div class="icon-circle bg-{{ $chamCong->kiemTraVeSom() ? 'warning' : 'success' }} text-white d-flex align-items-center justify-content-center rounded-circle me-3"
                                                style="width: 40px; height: 40px;">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="badge bg-{{ $chamCong->kiemTraVeSom() ? 'warning' : 'success' }} rounded-pill px-2 py-1">
                                                    {{ $chamCong->gio_ra_format }}
                                                </span>
                                                @if($chamCong->phut_ve_som > 0)
                                                    <br><small class="text-warning fw-medium">Về sớm: {{ $chamCong->phut_ve_som }}
                                                        phút</small>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <h4 class="text-primary mb-0">{{ number_format($chamCong->so_gio_lam, 1) }} giờ</h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            ...
                                            <div>
                                                ...
                                                <h4 class="text-warning mb-0">{{ number_format($chamCong->so_cong, 1) }} công</h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-2 rounded hover-bg-light transition">
                                            <div class="icon-circle bg-{{ $statusColors[$chamCong->trang_thai] ?? 'secondary' }} text-white d-flex align-items-center justify-content-center rounded-circle me-3"
                                                style="width: 40px; height: 40px;">
                                            ...
                                            <div>
                                                ...
                                                @endphp
                                                <span
                                                    class="badge bg-{{ $statusColors[$chamCong->trang_thai] ?? 'secondary' }} rounded-pill px-2 py-1">
                                        ...
                                        <div class="card border-0 bg-light">
                                            <div class="card-body">
                                                ...
                                                <small class="text-muted">
                                                    {{ \Carbon\Carbon::parse($chamCong->created_at)->format('d/m/Y H:i') }}
                                                </small>
                                            </div>
                                        </div>
                                    </div>

                                    @if($chamCong->trang_thai_duyet)
                        ...
                        <div class="card stat-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span
                                        class="float-end">{{ \Carbon\Carbon::parse($chamCong->created_at)->format('d/m/Y H:i') }}</span>
                                </div>

                                <div class="detail-row">
                                    <strong><i class="mdi mdi-clock-edit me-2 text-warning"></i>Cập nhật cuối:</strong>
                                    <span
                                        class="float-end">{{ \Carbon\Carbon::parse($chamCong->updated_at)->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center gap-3">
                                    ...
                                    @if($chamCong->trang_thai_duyet == 3 || !$chamCong->trang_thai_duyet)
                                        ...
                                        <button class="btn btn-danger" onclick="pheDuyet({{ $chamCong->id }}, 2)">
