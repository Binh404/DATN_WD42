                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gioi_tinh" id="gioi_tinh" class="form-control">
                            ...
                            <option value="nam"
                                {{ old('gioi_tinh', $hoSo->gioi_tinh ?? '') == 'nam' ? 'selected' : '' }}>Nam</option>
                            <option value="nu" {{ old('gioi_tinh', $hoSo->gioi_tinh ?? '') == 'nu' ? 'selected' : '' }}>
                                Nữ</option>
                            <option value="khac"
                                {{ old('gioi_tinh', $hoSo->gioi_tinh ?? '') == 'khac' ? 'selected' : '' }}>Khác</option>
                        </select>
                        @error('gioi_tinh')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tinh_trang_hon_nhan" id="tinh_trang_hon_nhan" class="form-control">
                            ...
                            <option value="doc_than"
                                {{ old('tinh_trang_hon_nhan', $hoSo->tinh_trang_hon_nhan ?? '') == 'doc_than' ? 'selected' : '' }}>
                                Độc thân</option>
                            <option value="da_ket_hon"
                                {{ old('tinh_trang_hon_nhan', $hoSo->tinh_trang_hon_nhan ?? '') == 'da_ket_hon' ? 'selected' : '' }}>
                                Đã kết hôn</option>
                            <option value="ly_hon"
                                {{ old('tinh_trang_hon_nhan', $hoSo->tinh_trang_hon_nhan ?? '') == 'ly_hon' ? 'selected' : '' }}>
                                Ly hôn</option>
                            <option value="goa"
                                {{ old('tinh_trang_hon_nhan', $hoSo->tinh_trang_hon_nhan ?? '') == 'goa' ? 'selected' : '' }}>
                                Góa</option>
                        </select>
