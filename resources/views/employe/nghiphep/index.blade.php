                                        ...
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h4 class="card-title card-title-dash">Bảng đơn xin nghỉ phép</h4>
                                                    ...
                                                    <div>
                                                        <a href="{{ route('nghiphep.create') }}" class="btn btn-primary btn-lg mb-0 me-0 text-white" type="button">
                                                            <i class="mdi mdi-plus-circle-outline me-1"></i> Tạo đơn nghỉ phép
                                                        </a>
                                                        ...
                                                        <tbody>
                                                            @forelse($donXinNghis as $key => $item)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-muted">{{ $item->ngay_bat_dau->format('d/m/Y') }}</td>
                                                                    <td class="text-muted">{{ $item->ngay_ket_thuc->format('d/m/Y') }}</td>
                                                                    ...
                                                                    <td >
                                                                        <span class="{{ $classes[$trangThai] ?? 'bg bg-secondary' }} text-white">
                                                                            {{ $labels[$trangThai] ?? 'Không xác định' }}
                                                                        </span>
                                                                    </td>
                                                                    <td>
                                                                        <a href="{{ route('nghiphep.show', ['id' => $item->id]) }}" class="btn btn-info"
                                                                            title="Xem">
